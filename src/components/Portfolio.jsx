      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        {projects.map((project, index) => (
          <ScrollReveal
            ...
            delay={index * 0.1}
            className={`
              group relative border-r border-min-black border-b border-min-black 
              ${index >= projects.length - 2 ? 'border-b-0' : ''}
              last:border-r-0 md:nth-last-child-2:border-b-0 md:even:border-r-0
              aspect-[4/3] flex flex-col justify-between p-8 overflow-hidden
          ...
          >
            ...
            <div className="z-10 relative">
              <h3 className="font-sans text-5xl md:text-6xl font-medium tracking-tighter uppercase mb-2 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                {project.title}
              </h3>
              <p className="font-mono text-sm uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                {project.category}
              </p>
            </div>
