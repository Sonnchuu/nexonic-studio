...
const Contact = () => {
  ...
  return (
    <div id="contact" className="bg-white text-min-black border-b border-min-black">
      {/* Header */}
      <div className="border-b border-min-black px-6 sm:px-8 lg:px-12 py-12 flex justify-between items-end">
        ...
        <span className="font-mono text-sm tracking-widest hidden md:block">INIT/SEQ</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <ScrollReveal>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <span className="font-mono text-xs uppercase tracking-widest w-20">Email</span>
                <a href="mailto:hello@nexonic.studio" className="font-sans text-lg underline decoration-1 underline-offset-4 hover:no-underline">hello@nexonic.studio</a>
              </div>
              <div className="flex items-center gap-4">
                <span className="font-mono text-xs uppercase tracking-widest w-20">Loc</span>
        ...
        <form onSubmit={handleSubmit} className="grid grid-rows-3">
          <ScrollReveal delay={0.1} className="border-b border-min-black p-0 group focus-within:bg-min-black focus-within:text-white transition-colors duration-300">
            <input
              type="text"
              name="customer_name"
              required
          ...
          <ScrollReveal delay={0.2} className="border-b border-min-black p-0 group focus-within:bg-min-black focus-within:text-white transition-colors duration-300">
            <input
              type="email"
              name="customer_email"
              required
          ...
          <ScrollReveal delay={0.3} className="p-0 flex border-b border-min-black lg:border-b-0">
